      ...
      <div className={`${CARD} overflow-hidden`}>
        ...
        <div className="grid gap-6 px-6 py-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.85fr)]">
          <div className="min-w-0">
            ...
            <p className="mt-2 text-[13px] leading-relaxed text-brand-muted">{t(`growthSprint.stage.${sprint.stage}`)}</p>
          ...
          <div className="rounded-xl border border-brand-line bg-brand-inset px-5 py-5">
            <div className="flex items-end justify-between gap-3">
              ...
              <span className="text-[13px] font-semibold tabular-nums text-brand-ink">{progress.percent}%</span>
            </div>
            <div className="mt-3.5 h-1.5 overflow-hidden rounded-full bg-brand-card">
              <div className="h-full rounded-full bg-brand-violet transition-all duration-500" style={{ width: `${progress.percent}%` }} />
            </div>
            <p className="mt-3.5 text-[12px] leading-relaxed text-brand-muted">
              {t('growthSprint.progress.days', { current: progress.effectiveDays, target: progress.weeklyTargetDays })}
            </p>
          </div>
        </div>
